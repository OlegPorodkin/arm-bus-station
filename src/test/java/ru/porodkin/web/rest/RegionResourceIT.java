...
import ru.porodkin.repository.RegionRepository;
import ru.porodkin.service.dto.RegionDTO;
import ru.porodkin.service.mapper.RegionMapper;
...
class RegionResourceIT {
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region().uuid(DEFAULT_UUID).name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return region;
    }
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region().uuid(UPDATED_UUID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return region;
    }
    ...
    void putNewRegion() throws Exception {
        ...
        updatedRegion.uuid(UPDATED_UUID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateRegionWithPatch() throws Exception {
        ...
        partialUpdatedRegion.uuid(UPDATED_UUID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
