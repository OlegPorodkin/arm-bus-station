...
import ru.porodkin.repository.CountryRepository;
import ru.porodkin.service.dto.CountryDTO;
import ru.porodkin.service.mapper.CountryMapper;
...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().uuid(DEFAULT_UUID).name(DEFAULT_NAME);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().uuid(UPDATED_UUID).name(UPDATED_NAME);
        return country;
    }
    ...
    void createCountry() throws Exception {
        ...
        assertThat(testCountry.getUuid()).isEqualTo(DEFAULT_UUID);
    ...
    void putNewCountry() throws Exception {
        ...
        updatedCountry.uuid(UPDATED_UUID).name(UPDATED_NAME);
        ...
        Country testCountry = countryList.get(countryList.size() - 1);
        assertThat(testCountry.getUuid()).isEqualTo(UPDATED_UUID);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.uuid(UPDATED_UUID);
    ...
    void fullUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.uuid(UPDATED_UUID).name(UPDATED_NAME);
