...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ru.porodkin.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ru.porodkin.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, ru.porodkin.domain.User.class.getName());
            createCache(cm, ru.porodkin.domain.Authority.class.getName());
            ...
            createCache(cm, ru.porodkin.domain.Route.class.getName() + ".passengers");
